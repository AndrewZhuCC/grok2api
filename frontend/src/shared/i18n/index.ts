...
const resources = {
  ...
  en: {
    translation: {
      ...
      nav: { dashboard: "Dashboard", accounts: "Accounts", models: "Models", clientKeys: "Client keys", creativeConsole: "Creative console", gallery: "Gallery", videoGallery: "Video Gallery", audits: "Request audits", resinQualityGuard: "Resin quality guard", docs: "Documentation", settings: "Settings" },
      resinQualityGuard: {
