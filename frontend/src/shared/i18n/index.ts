...
qualityGuard: "质量守护",
      ...
      qualityGuard: {
        ...
        resinHelp: "进程内监控 Grok Build 流式首信号：若无 thinking 直接 content，则打断、清 Resin 租约并透明重试一次。",
