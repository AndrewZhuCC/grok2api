...
qualityGuard: "质量守护",
      ...
      qualityGuard: {
        ...
        unavailable: "官方节点质量守护未连接", unavailableHelp: "这是官方 egress 节点 sidecar（quality-guard profile）。未启动时不影响上方 Resin 流式降智守护。若需要节点级被动/主动隔离，再在 config.yaml 启用 qualityGuard 并 docker compose --profile quality-guard up -d。", unavailableResinNote: "Resin 流式监控与一键清池不依赖该 sidecar，已在上方独立显示。", testing: "正在检测节点质量", testComplete: "检测完成：{{speed}}", testFailed: "质量检测暂不可用，请稍后重试",
        ...
        profileActive: "当前使用", profileBuiltin: "内置", profileCustom: "自定义",
        profileCreate: "新建方案", profileEdit: "编辑方案", profileView: "查看方案",
        profileName: "名称", profilePrompt: "探测 Prompt", profileExpected: "预期标记",
        profileExpectedHelp: "留空则只看 Token/s；有标记时短回复命中不因虚高 TPS 误杀",
        profileMatch: "匹配方式", profileMatchContains: "全文包含", profileMatchLastLine: "最后一行", profileMatchRegex: "正则",
        profileSaved: "方案已保存", profileDeleted: "方案已删除",
        profileDeleteConfirm: "将删除“{{name}}”。若正在使用会回退到预期标记。",
        profileActivate: "设为当前", profileNoExpected: "无预期标记",
        degrade: {
          tab: "降智账号", overview: "降智账号概览", series: "降智时序", nodes: "按出口节点",
          hits: "降智次数", hitsHelp: "burst {{burst}} · soft {{soft}} · hard {{hard}}",
          accounts: "涉及账号", accountsHelp: "窗口内去重", stillEnabled: "仍在调度", stillEnabledHelp: "漏网，可批量禁",
          maxTPS: "峰值 TPS", maxTPSHelp: "单次请求最高",
          accountsTitle: "降智账号", accountsHint: "显示 {{shown}} / {{total}}", accountsHintFiltered: "显示 {{shown}} / {{total}} · 命中≥{{min}}",
          search: "搜邮箱 / ID", statusAll: "全部状态", statusOn: "仍在调度", statusOff: "已禁言",
          ...
          muteSelected: "禁掉所选", muteSelectedCount: "禁掉所选 ({{count}})", muteConfirm: "确认禁掉 {{count}} 个仍在调度的降智账号？", muting: "正在禁言账号", muted: "已禁言 {{count}} 个账号", muteFailed: "禁言失败", unmuteSelected: "解除禁用", unmuteSelectedCount: "解除禁用 ({{count}})", unmuteConfirm: "确认恢复 {{count}} 个已禁账号到调度？", unmuting: "正在恢复账号", unmuted: "已恢复 {{count}} 个账号", unmuteFailed: "恢复失败",
          scheduling: "调度", mutedStatus: "已禁",
          events: "最近事件", eventsHelp: "用户请求，不含 quality-test 探针",
          noHits: "这个窗口没有降智请求", noNodes: "无节点数据", noAccounts: "没有匹配账号", noEvents: "无事件",
        },
        resinTitle: "Resin 流式降智守护",
        resinHelp: "进程内监控 Grok Build 流式首信号：若无 thinking 直接 content，则打断、清 Resin 租约，并对每一次重试再次 preflight，直到恢复或达到最大尝试次数。可随时关闭：关闭后不打断、不清池、不透明重试。",
        resinDisabledHint: "未启用。设置 RESIN_QUALITY_GUARD_ENABLED=true 与 RESIN_ADMIN_TOKEN 后重启即可在此查看流式统计与一键清池。",
        resinStreamWatch: "流式首信号监控",
        resinWatchToggle: "降智打断",
        resinWatchOffHint: "已关闭：检测到降智也不会打断流、清池或透明重试",
        resinWatchEnabled: "降智守护已开启（会打断并重试）",
        resinWatchDisabled: "降智守护已关闭（不打断、不清池、不重试）",
        resinWatchToggleFailed: "切换降智守护失败",
        resinLastSignal: "最近流式判定",
        resinDegraded: "降智",
        resinStreamStats: "流式统计",
        resinStreamStatsDetail: "总 {{total}} · 健康 {{healthy}} · 降智 {{degraded}} · 已重试 {{retried}}",
        resinReshuffles: "因降智触发的清池次数",
        resinReshuffle: "一键清空 Resin 租约",
        resinReshuffling: "正在清空 Resin 租约…",
        resinReshuffleDone: "已清理 {{cleared}} 条 Resin 租约",
        resinReshuffleFailed: "清空 Resin 租约失败",
        resinMaxAttempts: "最大尝试",
        resinMaxAttemptsHint: "含首次，共最多 {{count}} 次；每次重试都会再 preflight",
        resinMaxAttemptsInvalid: "最大尝试次数需在 1–8",
        resinMaxAttemptsSaved: "流式最大尝试次数已保存",
        resinMaxAttemptsSaveFailed: "保存最大尝试次数失败",
        resinLastAttempts: "用了 {{count}} 次才结束",
        resinRecoveredDetail: "恢复分布 1次 {{at1}} · 2次 {{at2}} · 3次 {{at3}} · 4+ {{at4}} · 耗尽 {{exhausted}}",
      },
      resinQualityGuard: {
        title: "Resin 质量守护",
        subtitle: "对 Resin 粘性出口池做降智/异常判定，并在池内清 lease 换路（进程内置，无需旁路 sidecar）。",
        disabledHint: "未启用。请在进程环境设置 RESIN_QUALITY_GUARD_ENABLED=true 与 RESIN_ADMIN_TOKEN 后重启。",
        status: "池状态",
        healthy: "正常",
        quarantined: "隔离中",
        lastExitIp: "最近出口 IP",
        ...
        events: "最近事件",
        probe: "主动探测",
        reshuffle: "清空全部 lease",
        reshuffling: "正在清空 lease…",
        reshuffleDone: "已清理 {{cleared}} 条 lease",
        probing: "正在探测…",
        probeDone: "探测完成，TPS {{tps}}",
        actionFailed: "操作失败",
        probeKeyHint: "探测用客户端密钥（与创作控制台相同，自动列出已启用 Key，进程内解密，无需手填）",
        selectKey: "选择密钥",
        autoKey: "自动（第一把可用 Key）",
        noKeys: "没有已启用的客户端密钥。请先到「密钥」页创建一把，再回来探测。",
        effectiveKey: "当前生效 Key ID：{{id}}",
        keySaved: "探测密钥已更新",
        passiveHeartbeat: "被动心跳",
        lastPassiveSample: "最近被动采样",
        lastPassiveReason: "最近判定原因",
        lastPassiveClass: "最近判定类别",
        passiveStats: "被动统计 total/healthy/soft/hard/ignored",
        recentSoftSamples: "最近 soft 样本",
        noSoftSamples: "暂无 soft 样本",
        secondsAgo: "{{n}} 秒前",
        auditId: "审计 ID",
        tokens: "tokens",
      },
      ...
      models: {
        ...
        syncStarted: "模型同步已在后台继续，刷新页面可查看账号支持数变化",
        created: "模型路由已创建",
        updated: "模型路由已更新",
        deleted: "模型路由已删除",
      ...
      audits: {
        ...
        errorLabel: "错误",
        qualityGuardInterrupt: "质量守护打断",
        qualityGuardInterruptHint: "流式首信号无有效 thinking，已被 Resin 降智守护打断并触发重试",
...
nav: { dashboard: "Dashboard", accounts: "Accounts", models: "Models", clientKeys: "Client keys", creativeConsole: "Creative console", gallery: "Gallery", videoGallery: "Video Gallery", audits: "Request audits", qualityGuard: "Quality guard", resinQualityGuard: "Resin quality guard", docs: "Documentation", settings: "Settings" },
      qualityGuard: { title: "Quality guard", description: "Monitor Grok egress quality and quarantine anomalous nodes automatically.", overview: "Quality guard overview", serviceStatus: "Guard service", running: "Running", stale: "Status stale", mode: "Detection mode", availableNodes: "Enabled nodes", quarantinedNodes: "Quarantined", modes: { active: "Active probes", passive: "Passive audits", hybrid: "Hybrid" }, nodes: "Node quality", nodesHelp: "Speed matches the grok2api panel: output tokens include reasoning tokens. Passive anomalies only trigger an active confirmation. Strike counts are passive / active / errors.", updatedAt: "Updated {{time}}", node: "Node", state: "State", outputTPS: "Panel output speed", firstToken: "First token", source: "Source", strikes: "Strikes", lastObserved: "Last observed", test: "Test", sources: { active: "Active probe", passive: "Request audit" }, quarantined: "Quarantined", fixedFallback: "Fixed fallback (protected)", suspect: "Suspect", healthy: "Healthy", pending: "Pending", probeFailed: "Probe failed", events: "Recent events", noEvents: "No anomaly or recovery events", eventTypes: { node_quarantined: "Node quarantined", node_restored: "Node restored", node_rotated: "Node IP rotated", passive_audit_anomaly: "Anomalous request detected" }, statistics: "Automatic detection statistics", statisticsSince: "Accumulated since {{time}}. Manual tests are excluded.", statisticsChecks: "Valid checks", statisticsChecksHelp: "Active probes and valid passive audits", statisticsActive: "Active probes", statisticsActiveDetail: "Healthy {{healthy}}, errors {{errors}}", statisticsPassive: "Passive audits", statisticsPassiveDetail: "Healthy {{healthy}}, from real requests", statisticsTokens: "Active output tokens", statisticsTokensHelp: "Includes reasoning tokens; not proxy traffic", statisticsAnomalies: "Anomaly hits", statisticsAnomalyDetail: "Soft {{soft}}, hard {{hard}}", statisticsQuarantines: "Quarantines applied", statisticsActionDetail: "Restored {{restored}}, protected {{suppressed}}", reasons: { unknown: "No reason recorded", hard_tps: "Hard threshold exceeded", soft_tps: "Soft threshold exceeded", buffered_burst: "Short-window output burst; retesting the same IP", passive_hard_tps: "Request exceeded hard threshold", passive_soft_tps: "Requests repeatedly exceeded soft threshold", quality_probe_healthy: "Model quality probe recovered", expected_marker_missing: "Expected marker missing", insufficient_output_tokens: "Too few output tokens", insufficient_visible_tokens: "Too few visible tokens", insufficient_generation_window: "Generation window too short", probe_errors: "Repeated probe errors", probe_no_account: "No schedulable probe account; retry deferred", recovery_probe_error: "Recovery probe failed", rotation_error: "IP rotation failed" }, policy: "Current policy", editPolicy: "Edit policy", editPolicyTitle: "Edit quality guard policy", editPolicyDescription: "The guard hot-reloads saved changes without a service restart.", restoreDefaults: "Restore defaults", policySaved: "Policy saved and queued for hot reload", invalidPolicyValue: "Value is outside the allowed range", softThresholdMustBeLower: "The soft threshold must be lower than the hard threshold", activeIntervalSeconds: "Active interval (seconds)", passiveIntervalSeconds: "Passive interval (seconds)", consecutiveSoft: "Consecutive soft strikes", consecutiveErrors: "Consecutive probe errors", quarantineSeconds: "Quarantine (seconds)", softThreshold: "Soft threshold", hardThreshold: "Hard threshold", activeInterval: "Active interval", passiveInterval: "Audit interval", quarantineDuration: "Quarantine", minimumNodes: "Minimum nodes", unavailable: "Official node quality guard is not connected", unavailableHelp: "This is the official egress-node sidecar (quality-guard profile). It is optional and does not affect the Resin stream guard above. Enable qualityGuard in config.yaml and run docker compose --profile quality-guard up -d only if you need node-level passive/active quarantine.", unavailableResinNote: "Resin stream watch and one-click lease clear do not depend on that sidecar; they are shown above independently.", testing: "Testing node quality", testComplete: "Test complete: {{speed}}", testFailed: "Quality test is temporarily unavailable. Try again shortly.", refreshNodes: "Refresh nodes", nodeEnabled: "Node enabled", nodeDisabled: "Node disabled", nodesEnabled: "Selected nodes enabled", nodesDisabled: "Selected nodes disabled", enableNode: "Enable node {{name}}", disableNode: "Disable node {{name}}", nodeEditorDescription: "Manage Grok Build egress used by the quality guard. Proxy URLs are write-only; leave the field blank while editing to keep the current value.", nodeCapacityHelp: "Maximum number of bound accounts; 0 means unlimited.", deleteNodeTitle: "Delete proxy node?", deleteNodeDescription: "Node “{{name}}” will be permanently deleted. This action cannot be undone.", deleteNodesTitle: "Delete {{count}} selected nodes?", deleteNodesDescription: "The selected proxy nodes will be permanently deleted. This action cannot be undone.", nodesTab: "Node quality", profilesTab: "Probe profiles", profilesHelp: "Prompt and expected marker for active quality probes. A missing marker is a hard failure.", profileActive: "In use", profileBuiltin: "Built-in", profileCustom: "Custom", profileCreate: "New profile", profileEdit: "Edit profile", profileView: "View profile", profileName: "Name", profilePrompt: "Probe prompt", profileExpected: "Expected marker", profileExpectedHelp: "Leave empty to score Token/s only. A short reply that hits the marker is not punished for burst TPS.", profileMatch: "Match mode", profileMatchContains: "Contains", profileMatchLastLine: "Last line", profileMatchRegex: "Regex", profileSaved: "Profile saved", profileDeleted: "Profile deleted", profileDeleteConfirm: "Delete “{{name}}”. If it is active, the guard falls back to the expected-marker profile.", profileActivate: "Use this", profileNoExpected: "No expected marker", degrade: { tab: "Degraded accounts", overview: "Degraded account overview", series: "Degrade timeline", nodes: "By egress node", hits: "Degrade hits", hitsHelp: "burst {{burst}} · soft {{soft}} · hard {{hard}}", accounts: "Accounts", accountsHelp: "Unique in this window", stillEnabled: "Still scheduled", stillEnabledHelp: "Still enabled; can be muted in bulk", maxTPS: "Peak TPS", maxTPSHelp: "Highest single request", accountsTitle: "Degraded accounts", accountsHint: "Showing {{shown}} / {{total}}", accountsHintFiltered: "Showing {{shown}} / {{total}} · hits ≥ {{min}}", search: "Search email / ID", statusAll: "All statuses", statusOn: "Still scheduled", statusOff: "Muted", classAll: "All classes", class: "Class", account: "Account", status: "Status", hitCount: "Hits", hitsAll: "Any hit count", hitsMin: "Hits ≥ {{count}}", windows: { "1h": "Last 1 hour", "6h": "Last 6 hours", "24h": "Last 24 hours", "7d": "Last 7 days" }, muteSelected: "Mute selected", muteSelectedCount: "Mute selected ({{count}})", muteConfirm: "Mute {{count}} still-scheduled degraded accounts?", muting: "Muting accounts", muted: "Muted {{count}} accounts", muteFailed: "Failed to mute accounts", unmuteSelected: "Unmute selected", unmuteSelectedCount: "Unmute selected ({{count}})", unmuteConfirm: "Restore {{count}} muted accounts to scheduling?", unmuting: "Restoring accounts", unmuted: "Restored {{count}} accounts", unmuteFailed: "Failed to restore accounts", scheduling: "Scheduled", mutedStatus: "Muted", events: "Recent events", eventsHelp: "User requests; quality-test probes are excluded", noHits: "No degrade requests in this window", noNodes: "No node data", noAccounts: "No matching accounts", noEvents: "No events" }, resinTitle: "Resin stream degradation guard", resinHelp: "In-process watch of Grok Build stream first signal: content without prior thinking interrupts, clears Resin leases, and re-preflights every transparent retry until healthy or the max attempts are reached. Turn it off anytime: when off there is no interrupt, pool clear, or transparent retry.", resinDisabledHint: "Disabled. Set RESIN_QUALITY_GUARD_ENABLED=true and RESIN_ADMIN_TOKEN, then restart to see stream stats and one-click clear here.", resinStreamWatch: "Stream first-signal watch", resinWatchToggle: "Degrade interrupt", resinWatchOffHint: "Off: degradation will not interrupt the stream, clear the pool, or transparently retry", resinWatchEnabled: "Degrade guard enabled (will interrupt and retry)", resinWatchDisabled: "Degrade guard disabled (no interrupt, clear, or retry)", resinWatchToggleFailed: "Failed to toggle degrade guard", resinLastSignal: "Last stream verdict", resinDegraded: "Degraded", resinStreamStats: "Stream stats", resinStreamStatsDetail: "total {{total}} · healthy {{healthy}} · degraded {{degraded}} · retried {{retried}}", resinReshuffles: "Reshuffles from degradation", resinReshuffle: "Clear all Resin leases", resinReshuffling: "Clearing Resin leases…", resinReshuffleDone: "Cleared {{cleared}} Resin leases", resinReshuffleFailed: "Failed to clear Resin leases", resinMaxAttempts: "Max attempts", resinMaxAttemptsHint: "Including the first try, up to {{count}} attempts; every retry is preflighted again", resinMaxAttemptsInvalid: "Max attempts must be between 1 and 8", resinMaxAttemptsSaved: "Stream max attempts saved", resinMaxAttemptsSaveFailed: "Failed to save max attempts", resinLastAttempts: "finished after {{count}} attempt(s)", resinRecoveredDetail: "recovered @1 {{at1}} · @2 {{at2}} · @3 {{at3}} · @4+ {{at4}} · exhausted {{exhausted}}" },
      resinQualityGuard: {
        title: "Resin quality guard",
        subtitle: "Detect degraded Resin sticky exits and reshuffle leases in-process (no sidecar).",
        disabledHint: "Disabled. Set RESIN_QUALITY_GUARD_ENABLED=true and RESIN_ADMIN_TOKEN, then restart.",
        status: "Pool status",
        healthy: "Healthy",
        quarantined: "Quarantined",
        lastExitIp: "Last exit IP",
        lastTps: "Last TPS",
        mode: "Mode / action",
        pool: "Pool details",
        softStrikes: "Soft strikes",
        errorStrikes: "Error strikes",
        quarantineUntil: "Quarantine until",
        lastReason: "Last reason",
        suspectIps: "Suspect exits",
        thresholds: "Soft/hard TPS",
        stats: "Statistics",
        events: "Recent events",
        probe: "Active probe",
        reshuffle: "Clear all leases",
        reshuffling: "Clearing leases…",
        reshuffleDone: "Cleared {{cleared}} leases",
        probing: "Probing…",
        probeDone: "Probe done, TPS {{tps}}",
        actionFailed: "Action failed",
        probeKeyHint: "Probe client key (same as creative console: list enabled keys, reveal in-process, no manual paste)",
        selectKey: "Select key",
        autoKey: "Auto (first usable key)",
        noKeys: "No enabled client keys. Create one under Client keys first.",
        effectiveKey: "Effective key ID: {{id}}",
        keySaved: "Probe key updated",
        passiveHeartbeat: "Passive heartbeat",
        lastPassiveSample: "Last passive sample",
        lastPassiveReason: "Last reason",
        lastPassiveClass: "Last class",
        passiveStats: "Passive total/healthy/soft/hard/ignored",
        recentSoftSamples: "Recent soft samples",
        noSoftSamples: "No soft samples yet",
        secondsAgo: "{{n}}s ago",
        auditId: "Audit ID",
        tokens: "tokens",
      },
      ...
      models: { title: "Model routes", description: "Configure multiple independent upstream targets for one client-facing model name. Requests remain session-sticky across schedulable targets and avoid unavailable targets automatically. Multiple public names may also target the same upstream model.", sync: "Sync models", search: "Search models", model: "Public model name", publicId: "Public model name", upstream: "Upstream model", provider: "Model source", providerGrokBuild: "Grok Build", providerGrokWeb: "Grok Web", accountSupport: "Supported accounts", lastSyncedAt: "Last synced", capability: "Account model capabilities", supportSummary: "{{supported}} available / {{total}} total", awaitingCapabilitySync: "Awaiting model capability sync", unknownCapability: "Pending sync", partialCapability: "Awaiting remaining accounts", available: "Available", unavailable: "Unavailable", status: "Status", create: "Add model", createTitle: "Add model route", createDescription: "Add a Grok Build route target. Public names are customizable and may be duplicated; targets with the same name form a scheduling pool. Public names omit the source prefix, while upstream models use Build/.", editTitle: "Edit model route", bindAccounts: "Bind specific accounts", boundAccounts: "Bound accounts", bindAccountsDescription: "Route only through selected accounts; when disabled, use synchronized model capabilities.", enabledDescription: "Controls whether this route participates in model discovery and request scheduling.", searchAccounts: "Search account name or ID", selectedAccounts: "{{count}} accounts selected", selectAccountRequired: "Select at least one account", noBindableAccounts: "No accounts from this provider can be bound", deleteTitle: "Delete model route?", deleteDescription: "This removes {{name}} and its client-key permissions. A later sync recreates it if upstream accounts still support the model.", batchDeleteTitle: "Delete {{count}} selected model routes?", batchDeleteDescription: "This removes the selected routes and their client-key permissions. Models still supported by upstream accounts are recreated on a later sync.",         synced: "Synced {{count}} models",
        syncStarted: "Model sync is continuing in the background. Refresh to see account support counts update.", created: "Model route created", updated: "Model route updated", deleted: "Model route deleted", batchDeleted: "Deleted {{count}} model routes", batchUpdated: "Selected models updated" },
      ...
      audits: {
        ...
        errorLabel: "Error",
        qualityGuardInterrupt: "Quality guard interrupt",
        qualityGuardInterruptHint: "Stream first signal had no valid thinking; Resin quality guard interrupted and retried",
