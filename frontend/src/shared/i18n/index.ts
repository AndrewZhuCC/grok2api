...
qualityGuard: "质量守护",
      ...
      qualityGuard: {
        ...
        resinHelp: "进程内监控 Grok Build 流式首信号：若无 thinking 直接 content，则打断、清 Resin 租约，并对每一次重试再次 preflight，直到恢复或达到最大尝试次数。",
