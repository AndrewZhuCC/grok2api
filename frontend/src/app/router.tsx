...
{ path: "/quality-guard", element: <DeferredQualityGuardPage /> },
          { path: "/resin-quality-guard", element: <DeferredResinQualityGuardPage /> },
