...
type Usage struct {
	// Reported indicates that the upstream stream supplied an explicit usage block.
	// It is used by request-path quality hold auditing; existing callers may leave it false.
	Reported               bool
	InputTokens            int64
